...
RUN  wget --quiet https://github.com/erlang/otp/releases/download/OTP-26.1.1/otp_src_26.1.1.tar.gz && \
     tar xzf otp_src_26.1.1.tar.gz
RUN  cd otp_src_26.1.1 && \
...
RUN  cd /usr/local && \
     wget --quiet https://github.com/elixir-lang/elixir/releases/download/v1.15.4/elixir-otp-26.zip && \
